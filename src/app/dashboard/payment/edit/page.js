...
//         console.log("this is your payment amount ",res.data.data);
...
//         // ✅ Wait for invoices to be loaded before proceeding
//         // Find matching invoice using invoice_no from payment data
//         const matchedInvoice = invoices.find(
//           (inv) => inv.invoice_no === d.invoice_no
//         );

//         const total = matchedInvoice ? Number(matchedInvoice.net_total || 0) : "";
//         const paid = matchedInvoice ? Number(matchedInvoice.total_paid_amt || 0) : "";
//         const payable = total !== "" && paid !== "" ? total - paid : "";
...
//           payableAmount: payable,
//           paymentType: d.payment_mode ?? "",
//         //  paidAmount: d.paid_amt ?? "",  // ✅ was d.paid_amount — wrong field name
//         });
...
//     // ✅ Only run after BOTH pay_id and invoices are available
//     if (pay_id && invoices.length > 0) {
//       loadData();
//     }
//   }, [pay_id, reset, invoices]); // ✅ add invoices as dependency
...
//     }, 1000); // waits 1 second then reloads
